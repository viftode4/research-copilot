...
def _normalize_codex_active_session(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "source": "codex",
        "runtime_id": str(payload.get("runtime_id") or payload.get("session_id") or ""),
        "workspace_id": str(payload.get("workspace_id") or payload.get("workspace") or ""),
        "generation_id": str(payload.get("generation_id") or ""),
        "brain_driver": str(payload.get("brain_driver") or "codex"),
        ...
        "experiment_id": str(payload.get("experiment_id") or payload.get("last_experiment_id") or ""),
        ...
        "last_watchdog_at": str(payload.get("last_watchdog_at") or ""),
        "lease_expires_at": "",
...
def _normalize_autonomous_active_session(payload: dict[str, Any]) -> dict[str, Any]:
    return {
        "schema_version": ACTIVE_SESSION_SCHEMA_VERSION,
        "source": "autonomous",
        "runtime_id": str(payload.get("runtime_id") or payload.get("run_id") or ""),
        "workspace_id": str(payload.get("workspace_id") or ""),
        "generation_id": str(payload.get("generation_id") or ""),
        "brain_driver": str(payload.get("brain_driver") or "workflow"),
        "health_state": str(payload.get("health_state") or ""),
